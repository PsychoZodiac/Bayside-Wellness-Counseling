      ...
      <div style={{ maxWidth: 1400, margin: "0 auto" }}>
        <div style={{
          ...
          <div>
            ...
            <div style={{ marginBottom: 8 }}>
              <button onClick={() => navigate("seo-directory")} style={{ 
                background: "none", border: "none", cursor: "pointer", padding: 0,
                fontFamily: "'DM Sans', sans-serif", fontSize: 12, color: colors.teal, textAlign: "left", fontWeight: 500
              }}
              onMouseEnter={e => e.target.style.color = colors.tealLight}
              onMouseLeave={e => e.target.style.color = colors.teal}
              >[TEST] View All SEO Pages ({Object.keys(seoPages).length})</button>
            </div>
          </div>
        </div>
      ...
      <div style={{ maxWidth: 1000, margin: "0 auto" }}>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ width: "100%", height: 600, overflow: "hidden", borderRadius: 4 }}>
              <iframe 
                src='https://baysidewellnessandcounseling.janeapp.com/#/staff_member/1/treatment/1' 
                width='100%'
                height='600'
                frameBorder='0' 
                scrolling='yes'
