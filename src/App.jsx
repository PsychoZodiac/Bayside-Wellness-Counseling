...
const seoPages = {
  ...
  "therapy-san-francisco": {
    ...
    intro: "Finding a therapist in San Francisco shouldn't add to your stress. Bayside Wellness & Counseling offers virtual therapy to adults and teens across all SF neighborhoods.",
  ...
  "therapy-emeryville": {
    ...
    intro: "Looking for therapy in Emeryville? We offer virtual mental health services to professionals and individuals throughout Emeryville and the surrounding East Bay.",
  ...
  "therapy-piedmont": {
    ...
    metaTitle: "Piedmont Therapist | LMFT | $240/session | Teen & Individual Therapy | Free Consultation",
    metaDescription: "Licensed Piedmont therapist (LMFT). Virtual teen therapy, anxiety treatment. $240/45min. Free 15-minute consultation. Book today.",
  ...
  "therapy-san-leandro": {
    ...
    intro: "San Leandro residents looking for therapy have options. Bayside Wellness & Counseling provides virtual mental health services to adults and teens throughout the East Bay.",
  ...
  "therapy-hayward": {
    ...
    intro: "Finding the right therapist in Hayward matters. We provide virtual therapy to adults and teens throughout Hayward and the greater East Bay.",
  ...
  "therapy-walnut-creek": {
    ...
    intro: "Looking for therapy in Walnut Creek? We provide virtual mental health services to adults, teens, and executives throughout Walnut Creek and Contra Costa County.",
  ...
  "therapy-concord": {
    ...
    intro: "Concord residents looking for mental health support have found the right place. We offer virtual therapy to adults and teens throughout Contra Costa County.",
  ...
  "therapy-richmond": {
    ...
    intro: "Richmond deserves accessible, quality mental health care. We provide virtual therapy to adults and teens throughout Richmond and West Contra Costa County.",
  ...
  "therapy-pleasant-hill": {
    ...
    metaTitle: "Pleasant Hill Therapist | LMFT | $240/session | Individual Therapy | Free Consultation",
    ...
    intro: "Pleasant Hill residents looking for therapy can access quality mental health care from home. We provide virtual therapy to adults and teens throughout Contra Costa County.",
  ...
  "therapy-san-jose": {
    ...
    metaDescription: "Licensed San Jose therapist (LMFT). Virtual EMDR, CBT, teen therapy. $240/45min. Serving Silicon Valley. Free 15-minute consultation. Book today.",
    h1: "Licensed Therapist in San Jose, CA | LMFT | Virtual Therapy",
    intro: "San Jose is the heart of Silicon Valley, and the pressure can be intense. We provide virtual therapy to adults and teens throughout San Jose and the South Bay.",
  ...
  "therapy-palo-alto": {
    ...
    intro: "Palo Alto is known for excellence, but the pressure to perform can take a toll. We provide virtual therapy to students, professionals, and teens throughout Palo Alto and the mid-Peninsula.",
  ...
  "therapy-mountain-view": {
    ...
    intro: "Mountain View professionals and families deserve accessible mental health support. We offer virtual therapy to adults, teens, and health care workers throughout Mountain View and the mid-Peninsula.",
  ...
  "therapy-redwood-city": {
    ...
    intro: "Redwood City residents deserve accessible, compassionate mental health care. We offer virtual therapy to adults, teens, and first responders throughout Redwood City and the Peninsula.",
  ...
  "therapy-san-mateo": {
    ...
    intro: "San Mateo families and professionals need mental health support that's both effective and convenient. We provide virtual therapy to adults and teens throughout San Mateo County.",
  ...
  "therapy-burlingame": {
    ...
    intro: "Burlingame residents deserve quality mental health support close to home. We provide virtual therapy to adults and teens throughout Burlingame and the Peninsula.",
  ...
  "therapy-millbrae": {
    ...
    intro: "Millbrae is a diverse community where mental health support should be accessible to everyone. We offer virtual therapy to adults and teens throughout Millbrae.",
  ...
  "therapy-pacifica": {
    ...
    intro: "Pacifica's coastal community deserves mental health support that's both accessible and effective. We provide virtual therapy to adults and teens throughout Pacifica.",
  ...
  "therapy-daly-city": {
    ...
    intro: "Daly City is one of the most diverse cities in California, and mental health support should reflect that. We offer virtual therapy to adults and teens throughout Daly City.",
  ...
  "therapy-south-san-francisco": {
    ...
    metaDescription: "Licensed South SF therapist (LMFT). Virtual therapy for biotech professionals. $240/45min. EMDR, CBT, Individual therapy. Free consultation.",
    h1: "Licensed Therapist in South San Francisco | LMFT | Virtual Therapy",
    intro: "South San Francisco is the biotech capital, and we know the pressure that comes with that. We provide virtual therapy to professionals and individuals throughout South City.",
  ...
  "therapy-menlo-park": {
    ...
    intro: "Menlo Park is home to innovators, entrepreneurs, and families navigating high-pressure environments. We provide virtual therapy to adults, teens, and founders throughout Menlo Park.",
  ...
  "therapy-san-rafael": {
    ...
    metaDescription: "Licensed San Rafael therapist (LMFT). Virtual EMDR, CBT, individual therapy. $240/45min. Serving Marin County. Free 15-minute consultation.",
    h1: "Licensed Therapist in San Rafael, CA | LMFT | Virtual Therapy",
    intro: "San Rafael is the heart of Marin County, and mental health support should be accessible to everyone. We provide virtual therapy to adults, teens, and professionals throughout San Rafael.",
  ...
  "therapy-sausalito": {
    ...
    intro: "Sausalito's waterfront community deserves accessible mental health support. We offer virtual therapy to adults, teens, and professionals throughout Sausalito and southern Marin.",
  ...
  "therapy-mill-valley": {
    ...
    metaTitle: "Mill Valley Therapist | LMFT | $240/session | Individual Therapy | Free Consultation",
    metaDescription: "Licensed Mill Valley therapist (LMFT). Virtual individual therapy, anxiety treatment, teen counseling. $240/45min. Free 15-minute consultation.",
  ...
  "therapy-novato": {
    ...
    intro: "Novato families and professionals deserve accessible mental health care. We offer virtual therapy to adults, teens, and industry workers throughout Novato and North Marin.",
  ...
  "therapy-vallejo": {
    ...
    intro: "Vallejo is a diverse, resilient community that deserves quality mental health support. We provide virtual therapy to adults, teens, and first responders throughout Vallejo and Solano County.",
  ...
  "therapy-petaluma": {
    ...
    intro: "Petaluma blends small-town charm with modern challenges. We provide virtual therapy to adults, teens, and professionals throughout Petaluma and southern Sonoma County.",
  ...
  "therapy-marin-city": {
    ...
    intro: "Marin City deserves mental health support that's both accessible and culturally responsive. We provide virtual therapy to adults, teens, and professionals throughout the community.",
