...
export default async function handler(req) {
  ...
  // We replace the static placeholder tags that are already in index.html,
  // or inject before </head> if they aren't present.
  const ogTags = `
  ...
  // Remove any existing og/twitter/canonical tags inserted statically,
  // then inject our dynamic ones before </head>
  html = html
